class Withholding_tax:
    def __init__(self):
        self.WITHHOLDING_TAX_CATEGORIES = {
    ...
    def check_residency(self, residence_type):
        if residence_type == "resident":
            return 0
        return 1

    def submit_input(self, category, residence, amount):
        tax_due = amount * self.WITHHOLDING_TAX_CATEGORIES[category][residence]
        return tax_due
